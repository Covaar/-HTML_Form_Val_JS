...
PaymentForm.addEventListener("submit", evento => {
  ...
  if (firstname.value === "") {
    ...
    errors["firstname"] =
      "First name debe ser válido (sin números ni carécteres especiales)";
    firstname.classList.add("is-invalid");
  } else {
  ...
  if (lastname.value === "") {
    ...
    errors["lastname"] =
      "Last name debe ser válido (sin números ni carácteres especiales)";
    lastname.classList.add("is-invalid");
  } else {
  ...
  if (city.value === "") {
    ...
    errors["city"] =
      "City debe ser un válido (sin números ni carácteres especiales)";
    city.classList.add("is-invalid");
  } else {
  ...
  if (
    ...
    if (errors["postalcode"])
      postalcodeFeedback.innerHTML = errors["postalcode"];
